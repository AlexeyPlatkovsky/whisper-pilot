...
| `collapse_to_bubble()` / `restore_main_from_bubble()`                                              | Transition between the main window and the native Recorder bubble while preserving a recoverable visible window and restoring the main window at the bubble position                                                                                                                                                                             | WP-110                |
| `set_bubble_always_on_top(value)`                                                                  | Apply and persist the bubble's Over All behavior, including visibility across macOS workspaces                                                                                                                                                                                                                                                     | WP-110                |
...
| `create_streaming_session()`                                                                       | Persist a stopped Meeting library item without starting system-audio capture                                                                                                                                                                                                                                                                       | WP-68                 |
...
| `show_recorder_workspace()`                                                                        | Show, unminimize and focus the main window, then emit `open_recorder_workspace` so the renderer routes to Recorder                                                                                                                                                                                                                                | WP-109                |
