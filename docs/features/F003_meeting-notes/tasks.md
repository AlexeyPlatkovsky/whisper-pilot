# F003 Structured Meeting Notes — Tasks
...
| F003-T2 | `generate_notes`: transcript → five-section structured notes via local LLM on Metal, driven by Create MFU (UI-blocking, spinner+timer) | F003-R1, F003-R2, F003-R6 | F003-T1 | — (unscheduled) |
...
- Prompt design for the five Russian sections (summary/decisions/action items/
  ...
  are present.
- Notes persist on the meeting via F004 (auto-save).
