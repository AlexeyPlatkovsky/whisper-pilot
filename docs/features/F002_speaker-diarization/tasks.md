...
| F002-T7 | Wire diarization into the Transcribe flow: run after transcription within one progress/Stop run; degrade to plain segments (with note) when unavailable | F002-R6, F002-R7 | F002-T3 | WP-31 |
