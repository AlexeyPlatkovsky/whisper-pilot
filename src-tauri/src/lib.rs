...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::streaming::streaming_library::list_streaming_sessions,
            commands::streaming::streaming_library::open_streaming_session,
            commands::streaming::streaming_library::rename_streaming_session,
            commands::streaming::streaming_library::delete_streaming_session,
            commands::streaming::streaming_library::clear_streaming_session,
            commands::streaming::streaming_library::list_streaming_translations,
            commands::streaming::streaming_library::create_streaming_session,
            commands::streaming::start_streaming_session,
            commands::streaming::stop_streaming_session,
            commands::streaming::streaming_lifecycle::get_live_capture_snapshot,
            commands::recorder::library::get_microphone_permission_status,
            commands::recorder::library::request_microphone_permission,
            commands::recorder::library::show_recorder_workspace,
            commands::recorder::library::list_recorder_sessions,
            commands::recorder::library::open_recorder_session,
            commands::recorder::library::create_recorder_draft,
            commands::recorder::library::rename_recorder_session,
            commands::recorder::library::delete_recorder_session,
            commands::recorder::library::clear_recorder_recording,
            commands::recorder::library::update_recorder_segment,
            commands::recorder::library::recover_recorder_session,
            commands::recorder::library::export_recorder_wav,
            commands::recorder::start_recorder_session,
            commands::recorder::stop_recorder_session,
            commands::streaming::streaming_library::set_streaming_translation_enabled,
            commands::streaming::streaming_library::set_streaming_translation_target_language,
